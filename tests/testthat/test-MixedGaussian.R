...
# regime 'a', trait 1
model.a.1 <- PCM("OU__Omitted_X0__H__Theta__UpperTriangularWithDiagonal_WithNonNegativeDiagonal_Sigma_x__UpperTriangularWithDiagonal_WithNonNegativeDiagonal_Sigmae_x", k = 1, regimes = "a", params = list(H=H[1,1,'a',drop=FALSE],
...
model.a.123 <- PCM(
  ...
  k = 3, regimes = "a", params = list(H=H[,,'a',drop=FALSE],
...
model.b.123 <- PCM(
  "OU__Omitted_X0__H__Theta__UpperTriangularWithDiagonal_WithNonNegativeDiagonal_Sigma_x__UpperTriangularWithDiagonal_WithNonNegativeDiagonal_Sigmae_x",
  k = 3, regimes = "b", params = list(H=H[,,'b',drop=FALSE],
...
model.ab.123 <- PCM(
  "OU", k = 3, regimes = c("a", "b"), params = list(X0 = a.X0,
                                                    H=H[,,,drop=FALSE],
...
PCMParamSetByName(model_MixedGaussian_ab, list(X0 = a.X0, a = model.a.123, b = model.b.123))
...
PCMParamSetByName(model_MixedGaussian_ab_globalSigmae_x,
                  list(X0 = a.X0,
                       a = model.a.123_noSigmae_x,
                       b = model.b.123_noSigmae_x, Sigmae_x=Sigmae_x[,,'b',drop=TRUE]))
