...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/PCMBase?color=blue)](http://cran.r-project.org/web/packages/PCMBase)
[![Downloads](http://cranlogs.r-pkg.org/badges/PCMBase?color=blue)](http://cran.rstudio.com/package=PCMBase)
