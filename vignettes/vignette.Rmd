...
The input data for the phylogenetic comparative methods covered in the PCMBase package consists of a phylogenetic tree of $N$ tips and a $N\times k$ matrix, $X$ of observed trait-values, where $k$ is the number of traits. The matrix $X$ can contain ```NA```s corresponding to missing values.
