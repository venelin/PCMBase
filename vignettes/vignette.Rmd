...
# generate traits
traits.a.1 <- PCMSim(tree.a, model.a.1, 0)
traits.a.2 <- PCMSim(tree.a, model.a.2, 0)
traits.a.3 <- PCMSim(tree.a, model.a.2, 0)
```
...
traits.a.123 <- PCMSim(tree.a, model.a.123, c(0,0,0))
```

# Calculating likelihoods
```{r}
# For the single trait models the likelihoods calculated with PCMLik and 
# POUMM::likPOUMMGivenTreeVTips should match exactly:
cat("PCMBase: \n")
PCMLik(traits.a.1$values + traits.a.1$errors, tree.a,
              model.a.1)
cat("POUMM: \n")
...
cat("PCMBase: \n")
PCMLik(traits.a.2$values + traits.a.2$errors, tree.a,
              model.a.2)
cat("POUMM: \n")
POUMM::likPOUMMGivenTreeVTips(
...
cat("PCMBase: \n")
PCMLik(traits.a.3$values + traits.a.3$errors, tree.a,
              model.a.3)
cat("POUMM: \n")
POUMM::likPOUMMGivenTreeVTips(
...
cat("PCMBase: \n")
PCMLik(X = traits.a.123$values + traits.a.123$errors, 
      tree = tree.a, 
      model = model.a.123)
cat("POUMM: \n")
POUMM::likPOUMMGivenTreeVTips(
