...
PCMTreeSetDefaultPartition(tree.a, part = "a")
...
PCMTreeSetPartition(tree.ab, nodes = splitNode, parts = c("a", "b"), inplace = TRUE)
...
plot(tree.ab, show.tip.label=FALSE, edge.color = palette[tree.ab$edge.part])
```
